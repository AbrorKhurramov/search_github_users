...
List<UserReposResponse> userReposResponseFromJson(String str) =>
    List<UserReposResponse>.from(
        json.decode(str).map((x) => UserReposResponse.fromJson(x)));

String userReposResponseToJson(List<UserReposResponse> data) =>
...
class UserReposResponse {
  ...
  factory UserReposResponse.fromJson(Map<String, dynamic> json) =>
      UserReposResponse(
        id: json["id"],
        nodeId: json["node_id"],
        name: json["name"],
